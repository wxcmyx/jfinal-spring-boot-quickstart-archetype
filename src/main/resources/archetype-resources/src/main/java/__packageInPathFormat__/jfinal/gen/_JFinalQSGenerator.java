...
public class _JFinalQSGenerator {
    ...
    public static void main(String[] args) {
        // base model 所使用的包名
        String baseModelPackageName = "com.wixct.pachong.jfinal.model.base";
        // base model 文件保存路径
        String baseModelOutputDir = PathKit.getWebRootPath() + "/src/main/java/com.wixct.pachong/jfinal/model/base";

        // model 所使用的包名 (MappingKit 默认使用的包名)
        String modelPackageName = "com.wixct.pachong.jfinal.model";
        ...
        generator.addIncludedTable("recitecontent");
        // 生成
        generator.generate();
    }
}
